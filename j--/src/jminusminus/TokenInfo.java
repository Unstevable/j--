...
enum TokenKind {
    ...
    CONTINUE("continue"), DEFLT("default"), DO("do"), DOUBLE("double"), FINALLY("finally"),
    ...
    NOT("~"), OR("|"), XOR("^"), AND("&"), ALSHIFT("<<"), ARSHIFT(">>"), LRSHIFT(">>>"),
    QUESTION("?"), COLON(":"), NOT_EQUAL("!="), DIV_ASSIGN("/="), MINUS_ASSIGN("-="), STAR_ASSIGN("*="),
    REM_ASSIGN("%="), ARSHIFT_ASSIGN(">>="), LRSHIFT_ASSIGN(">>>="), GE(">="), ALSHIFT_ASSIGN("<<="),
    LT("<"), XOR_ASSIGN("^="), OR_ASSIGN("|="), LOR("||"), AND_ASSIGN("&="),
    ...
    STRING_LITERAL("<STRING_LITERAL>"), TRUE("true"), DOUBLE_LITERAL("<DOUBLE_LITERAL>"),
