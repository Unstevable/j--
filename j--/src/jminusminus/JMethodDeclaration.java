...
class JMethodDeclaration extends JAST implements JMember {
    ...
    public JAST analyze(Context context) {
        ...
        for (JFormalParameter param : params) {
            ...
            // Long and doubles need an additional offset
            if (param.type().equals(Type.LONG) || param.type().equals(Type.DOUBLE)){
                this.context.nextOffset();
            }
        }
    ...
    /** Added long and double for project5
     * {@inheritDoc}
     */
    public void partialCodegen(Context context, CLEmitter partial) {
        ...
        } else if (returnType == Type.LONG){ // Added long for project5
            partial.addNoArgInstruction(LCONST_0);
            partial.addNoArgInstruction(LRETURN);
        }  else if (returnType == Type.DOUBLE){ // Added double for project5
