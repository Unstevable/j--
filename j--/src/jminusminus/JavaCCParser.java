...
{if ("" != null) return statement;}
  ...
  final private JStatement statement() throws ParseException {int line = 0;
    ...
    ArrayList<SwitchStatementGroup> switchBlockStmtGroup = null;
    SwitchStatementGroup switchStmtGrp                   = null;
...
line = token.beginLine;
        ...
        body = statement();
statement = new JForStatement(line, inits, expr, updates, body);
        break;
        }
      case IF:{
        jj_consume_token(IF);
...
line = token.beginLine;
          switchBlockStmtGroup = new ArrayList<SwitchStatementGroup>();
        test = parExpression();
        jj_consume_token(LCURLY);
        label_9:
        while (true) {
          ...
          switchStmtGrp = switchBlockStatementGroup();
switchBlockStmtGroup.add(switchStmtGrp);
        }
        jj_consume_token(RCURLY);
...
catchBlocks.add(cBlock);
        ...
        case FINALLY:{
          ...
          finallyBlock = block();
{if ("" != null) return new JTryStatement(line, tryBlock, params, catchBlocks, finallyBlock);}
          break;
          }
        default:
          jj_la1[22] = jj_gen;
...
statement = new JTryStatement(line, tryBlock, params, catchBlocks, null);
        break;
        }
      case WHILE:{
        jj_consume_token(WHILE);
...
{if ("" != null) return updates;}
  ...
  final private SwitchStatementGroup switchBlockStatementGroup() throws ParseException {ArrayList<JExpression> switchLabels = new ArrayList<JExpression>();
    ...
    JExpression swLabel = null;
    JStatement blockSt = null;
    try {
      swLabel = switchLabel();
switchLabels.add(swLabel);
      label_14:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
        case CASE:
...
{if ("" != null) return new SwitchStatementGroup(switchLabels, blockStatements);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return lhs;}
  ...
  final private JExpression conditionalExpression() throws ParseException {int line = 0;
      JExpression expr = null, thenPart = null, elsePart = null;
    try {
...
expr = new JConditionalExpression(line, expr, thenPart, elsePart);
        break;
        }
      default:
        jj_la1[47] = jj_gen;
