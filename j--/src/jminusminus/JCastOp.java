...
class Conversions {
    ...
    public Conversions() {
        ...
        put(Type.INT, Type.LONG, new I2L());    // Add int to long conversion
        put(Type.INT, Type.DOUBLE, new I2D());  // Add int to double conversion
        put(Type.LONG, Type.INT, new L2I());    // Add long to int conversion
        put(Type.LONG, Type.DOUBLE, new L2D()); // Add long to double conversion
        put(Type.DOUBLE, Type.INT, new D2I());  // Add double to int conversion
        put(Type.DOUBLE, Type.LONG, new D2L()); // Add double to long conversion
        ...
        put(Type.LONG, Type.BOXED_LONG, new Boxing(Type.LONG, Type.BOXED_LONG)); // Add long boxing
        put(Type.DOUBLE, Type.BOXED_DOUBLE, new Boxing(Type.DOUBLE, Type.BOXED_DOUBLE)); // Add double boxing
